...
import app.libre.databinding.BottomSheetBinding
import app.libre.ui.adapters.ChaptersAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter =
            ChaptersAdapter(chaptersViewModel.chapters, duration) {
                setFragmentResult(SEEK_TO_POSITION_REQUEST_KEY, Bundle().apply { putLong(IntentData.currentPosition, it) })
            }
