...
import app.libre.databinding.DialogAddToPlaylistBinding
import app.libre.extensions.parcelable
import app.libre.ui.models.AddToPlaylistViewModel
...
class AddToPlaylistDialog : DialogFragment() {
    ...
    override fun onDismiss(dialog: DialogInterface) {
        ...
        setFragmentResult(ADD_TO_PLAYLIST_DIALOG_DISMISSED_KEY, Bundle.EMPTY)
    }
