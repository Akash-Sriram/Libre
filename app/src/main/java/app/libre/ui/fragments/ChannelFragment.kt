...
import app.libre.databinding.FragmentChannelBinding
            ...
            ChannelOptionsBottomSheet()
                .apply {
                    arguments = Bundle().apply {
                        ...
                        putString(IntentData.channelName, channelName)
                        putBoolean(IntentData.isSubscribed, isSubscribed)
                    }
                }
...
class ChannelContentAdapter(
    ...
    override fun createFragment(position: Int) = ChannelContentFragment().apply {
        arguments = Bundle().apply {
            putParcelable(IntentData.tabData, list[position])
            putParcelableArrayList(IntentData.videoList, ArrayList(videos))
            putString(IntentData.channelId, channelId)
