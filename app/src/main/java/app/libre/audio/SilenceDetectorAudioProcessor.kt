...
/**
 * Lightweight PCM pass-through audio processor that detects long stretches of near-silence.
 * When [instantModeEnabled] is true and a silence block longer than [minSilenceDurationUs]
 * is detected, [onLongSilence] is invoked once per silent segment.
 *
 * Ported from Metrolist for gapless music playback in Libre.
 */
@UnstableApi
